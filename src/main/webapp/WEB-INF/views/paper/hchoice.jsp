...
<script type="text/javascript">
    ...
    function selectTitle(index) {
    	...
    	$("#singles").append("<tr><td><input type='checkbox' checked='checked' style='display:none;' id ='"+row.id+"' value='"+row.id+"'/>"+row.singleTitle+"</td><td><input type='text' id ='score"+row.id+"' placeholder='输入分数' name='score' size='4' /></td><td><a href='#' onclick='removeTitle(this);' >删除</a></td></tr>");
    }
    // 删除选择题目
