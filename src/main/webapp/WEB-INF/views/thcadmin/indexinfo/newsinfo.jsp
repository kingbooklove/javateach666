...
<div id="addnews-dialog" style="width:600px;height:500px; padding:10px;">
    <form id="addnews-form" method="post" >
        ...
        <table style="margin:0 auto; height:250px">
        	<tr>
        		<td>标题</td>
        		<td><input class="easyui-textbox" name="joutitle" class="easyui-textbox"/></td>
        	</tr>
    	    <tr>
    	    	<td>新闻类型</td>
	...
	<script type="text/javascript">
		    ...
		    $('#newsinfo-datagrid').datagrid({
		        ...
		        columns: [[
		            ...
		            {field: 'joutitle', title: '标题', width: 50, sortable: false},
		            {field: 'joucontent', title: '内容', width: 150, sortable: false},
		            {field: 'dicname', title: '新闻类型', width: 50, sortable: false},
		            {field: 'starttime', title: '创建时间', width: 100, sortable: false, formatter: function (value, row, index) {
		            	if(value != null) {
		            ...
		            {field: 'endtime', title: '过期时间', width: 100, sortable: false, formatter: function (value, row, index) {
		            	if(value != null) {
			            	var date = new Date(value);
			            	return date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate();
		            	} else {
